...
export function NotesList({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
    ...
    return (
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <Form>
                    <Stack gap={2}>
                        {!availableTags.length ? <p className="text-center">No tags found.</p> : availableTags.map(tag => (
                            <Row key={tag.id}>
                                <Col>
                                    <Form.Control
                                        type="text"
